...
namespace HangoverApp.Style
{
    public class PagerIndicatorTabs : Grid
    {
        ...
        public PagerIndicatorTabs()
        {
            ...
            Device.OnPlatform(iOS: () => BackgroundColor = Color.FromHex("#FF9800"), Android: () => BackgroundColor = Color.FromHex("#FF9800"));
        ...
        void CreateTabs()
        {
            ...
            {
                dynamic dyntab = (object)item;

                //   HomeViewModel hm = (HomeViewModel)item;
